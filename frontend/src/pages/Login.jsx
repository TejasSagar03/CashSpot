  ...
  return (
    <AnimatedPage>
      <div className="flex min-h-[100dvh] w-full bg-[#fdfdfd] dark:bg-[#050505] transition-colors duration-500 font-sans">
        ...
        {/* LEFT PANEL: Tactical Graphic (Hidden on Mobile) */}
        <div className="hidden lg:flex w-1/2 bg-[#050505] border-r border-white/5 relative items-center justify-center overflow-hidden p-12 lg:p-20">
          ...
          <div className="absolute opacity-[0.15]">
            <SchematicGlobeSVG className="w-[800px] h-auto animate-[spin_150s_linear_infinite] text-white" />
          </div>
          ...
          <div className="relative z-10 flex flex-col items-start w-full max-w-lg">
            <div className="flex items-center gap-3 mb-6">
              ...
              <span className="text-green-500 font-mono text-[10px] tracking-[0.3em] uppercase font-bold">Secure Uplink Active</span>
            </div>
            <h1 className="text-6xl xl:text-7xl font-bold text-white tracking-tighter leading-[0.9] mb-8">
              Locate.<br/>Navigate.<br/>Execute.
            </h1>
            <p className="text-gray-500 font-mono text-xs max-w-sm leading-relaxed">
              Access the decentralized network of active financial nodes. Hardware-accelerated and strictly confidential.
            </p>
          </div>
        </div>
        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12 relative">
          ...
          >
            <div className="mb-10 text-center lg:text-left">
              <h2 className="text-3xl font-bold text-black dark:text-white tracking-tight mb-2">Welcome Back</h2>
              <p className="text-sm text-gray-500 dark:text-gray-400 font-medium">Enter your credentials to access the grid.</p>
            </div>

            <div className="flex gap-4 w-full mb-8">
              <button type="button" onClick={() => handleOAuthLogin(googleProvider)} className="flex-1 py-3.5 flex items-center justify-center bg-white dark:bg-[#111] border border-gray-200 dark:border-gray-800 rounded-xl hover:bg-gray-50 dark:hover:bg-[#1a1a1a] transition-all shadow-sm">
              ...
              <button type="button" onClick={() => handleOAuthLogin(githubProvider)} className="flex-1 py-3.5 flex items-center justify-center bg-[#1a1a1a] text-white rounded-xl hover:bg-black transition-all shadow-md">
            ...
            <div className="flex items-center gap-4 mb-8">
              ...
              <span className="text-[9px] font-bold text-gray-400 uppercase tracking-[0.2em]">Or continue with</span>
              <div className="flex-1 h-[1px] bg-gray-200 dark:bg-gray-800"></div>
            </div>
            ...
            <form onSubmit={handleManualLogin} className="flex flex-col gap-5">
              ...
              <button type="submit" disabled={isLoading} className="w-full py-4 mt-4 bg-black dark:bg-white text-white dark:text-black rounded-xl text-[11px] font-bold uppercase tracking-widest hover:scale-[1.02] active:scale-[0.98] transition-transform shadow-lg disabled:opacity-50 flex items-center justify-center">
                {isLoading ? <div className="w-4 h-4 border-2 border-white/20 border-t-white dark:border-black/20 dark:border-t-black rounded-full animate-spin"></div> : "Access System"}
              </button>
            </form>

            <div className="mt-8 text-center">
              <Link to="/signup" className="text-xs font-medium text-gray-500 hover:text-black dark:hover:text-white transition-colors">
                Don't have an account? <span className="underline decoration-dashed underline-offset-4">Sign up here</span>
              </Link>
            </div>
          </motion.div>
        </div>
